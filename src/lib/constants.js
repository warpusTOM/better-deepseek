...
export const MCP_PRESET_CATALOG = [
  {
    id: "roblox-studio",
    name: "Roblox Studio",
    description: "Roblox Vibe Coding: inspect, edit, run, test, and verify live Studio projects through MCP.",
...
export const DEFAULT_SYSTEM_PROMPT = [
  ...
  "- Use canonical arguments: `execute_luau` requires `code` and `datamodel_type`; `script_read` requires `target_file`; `script_search` requires `keywords`; edit operations require `datamodel_type: \"Edit\"`.",
  "- Never invent an instance path. Use `search_game_tree`, `script_search`, or `inspect_instance` to locate it first.",
  "- Before destructive edits or broad refactors, explain the intended scope briefly and prefer reversible, focused changes.",
  "- After every meaningful change, verify with a readback, console output, or playtest and report any remaining Studio error honestly.",
  "",
  "DO NOT USE:",
